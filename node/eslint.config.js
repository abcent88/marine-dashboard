...
module.exports = [
  ...
  },
  {
    ...
    rules: {
      "no-unused-vars": ["warn", {
        "varsIgnorePattern": "^(loadVoyages|loadVessels|loadDashboardSummary|loadCrew|loadCatch|loadAlerts|loadMaintenance|loadFuel|loadReports|initVesselManagement)$"
      }],
      "no-undef": "error",
      "no-unreachable": "error"
    }
